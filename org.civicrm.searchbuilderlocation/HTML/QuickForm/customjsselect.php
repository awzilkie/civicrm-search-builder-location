...
/**
 * Class to dynamically create an HTML SELECT with a custom js
 * 
 * PHP versions 4,5,7
 *
 * LICENSE: 
 *
 * @author      Adam Zilkie <azilkie@gmail.com>
 * @version     1.0
 * @access      public
 */
class HTML_QuickForm_customjsselect extends HTML_QuickForm_element {
    ...
    function addJS($customjs)
    {
     error_log("In HTML_QuickForm_customjsselect.addJS",3,"/var/tmp/AZdebug.log");
error_log(PHP_EOL,3,"/var/tmp/AZdebug.log");
    ...
    function toHtml()
    {
    error_log("In HTML_QuickForm_customjsselect.toHtml",3,"/var/tmp/AZdebug.log");
error_log(PHP_EOL,3,"/var/tmp/AZdebug.log");
        if ($this->_flagFrozen) {
            ...
            return $this->_js . $strHtml . $tabs . '</select>';
        }
    } //end func toHtml
    ...
    */
    ...
    // }}}
} //end class HTML_QuickForm_customjsselect
?>
